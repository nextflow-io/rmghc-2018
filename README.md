# Nextflow Workshop at RMGHC 2018

This repository contains the material for the Nextflow workshop that forms part 
of the [Rocky Mountain Genomics HackCon 2018](https://hackathon.colorado.edu/) in Boulder, 
Colorado between 18 and 23 June 2018.

![Poster](https://hackathon.colorado.edu/media/images/2018hackathon.width-800.png)


## Prerequisites

We have provided AWS instances for users for the duration of the workhop. 

During this period, the only requirement is a computer with ssh access.
...
Whilst the pipeline runs you can examine the [execution report](https://cdn.rawgit.com/nextflow-io/rmghc-2018/master/assets/MethylSeq_report.html), [timeline](https://cdn.rawgit.com/nextflow-io/rmghc-2018/master/assets/MethylSeq_timeline.html) and [MultiQC report](https://cdn.rawgit.com/nextflow-io/rmghc-2018/master/assets/MethylSeq_report.html) for the same pipeline in the links.
...
1. Index a trascriptome file 
2. Perform quality control measures using FastQC
3. Performs quantification of reads
4. Create a MultiqQC report

Throughout this tutorial we will use a series of minimal Nextflow scripts which aim to slowly introduce how to do things in Nextflow.

Before running each file, be sure to examine the script and try to understand what is happening.

If in doubt, first refer to the [documentation](https://www.nextflow.io/docs/latest/index.html).

## Step 1 - Pipeline Inputs (parameters) 
...
1. How to define input parameters in your pipeline script
2. How to pass parameters using the command line


### Step 2 - Pipeline Processes (Create transcriptome index file)
...
4. How to invoke containers
4. How work directories are organised
